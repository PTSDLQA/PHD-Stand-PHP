...
class Smarty
{
    ...
    public $security_settings  = array(
                                    'PHP_HANDLING'    => false,
                                    'IF_FUNCS'        => array('strpos','isset','empty','count','time','in_array','is_array','getAccess','true','false'),
                                    'INCLUDE_ANY'     => false,
                                    'PHP_TAGS'        => false,
                                    'MODIFIER_FUNCS'  => array('count','round'),
    ...
    function trigger_error($error_msg, $error_type = E_USER_WARNING)
    {
        ...
        print "Smarty error: $error_msg<br>";
    }
   ...
   /**
     ...
     * @return boolean
     */
    protected function _is_compiled($resource_name, $compile_path)
    {
   ...
   /**
     ...
     * @return boolean
     */
    protected function _compile_resource($resource_name, $compile_path)
    {
   ...
   /**
     ...
     * @return boolean
     */
    protected function _compile_source($resource_name, &$source_content, &$compiled_content, $cache_include_path=null)
    {
     ...
     */
    protected function _get_compile_path($resource_name)
    {
    ...
    protected function _fetch_resource_info(&$params)
    {
    ...
    protected function _parse_resource_name(&$params)
    {
     ...
     */
    protected function _run_mod_handler()
    {
        $_args = func_get_args();
     ...
     * @return string
     */
    protected function _read_file($filename)
    {
     ...
     * @staticvar string|null
     */
    protected function _get_auto_filename($auto_base, $auto_source = null, $auto_id = null)
    {
     ...
     */
    protected function _unlink($resource, $exp_time = null)
    {
        if(isset($exp_time)) {
     ...
     * @return string|null
     */
    protected function _get_auto_id($cache_id=null, $compile_id=null) {
    if (isset($cache_id))
     ...
     * @param integer $error_type
     */
    protected function _trigger_fatal_error($error_msg, $tpl_file = null, $tpl_line = null,
     ...
     * @return string
     */
    protected function _process_compiled_include_callback($match) {
    ...
    protected function _smarty_include($params)
    {
        if ($this->debugging) {
            $_params = array();
            require_once(SMARTY_CORE_DIR . 'core.get_microtime.php');
     ...
     * @return array
     */
    protected function &_smarty_cache_attrs($cache_serial, $count) {
     ...
     * @return mixed
     */
    protected function _include($filename, $once=false, $params=null)
    {
        if ($once) {
     ...
     * @return string
     */
	protected function _get_filter_name($function)
	{
