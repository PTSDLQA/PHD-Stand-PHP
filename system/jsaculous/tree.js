...
this.struct.img=icon;
this.struct.imgopen =(iconOpen)? iconOpen:null;
this.struct.imgclose =(iconClose)? iconClose:null;
},
...
params += '&treedrag_id='+this.tree.id+'&treedrop_id='+newParentObj.tree.id+'&sibling='+sibling;
