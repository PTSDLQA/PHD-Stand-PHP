...
FCKCommands.RegisterCommand( 'typograf'		, new FCKDialogCommand( FCKLang.DlgMyTypografTitle	, FCKLang.DlgMyTypografTitle		, FCKConfig.PluginsPath + 'typograf/typograf.html'	,800 , 600)) ;
var oTypografItem		= new FCKToolbarButton( 'typograf', FCKLang['DlgMyTypografTitle'] ) ;
oTypografItem.IconPath	= FCKConfig.PluginsPath + 'typograf/typograf.gif' ;
FCKToolbarItems.RegisterItem( 'typograf', oTypografItem ) ;			// 'My_Find' is the name used in the Toolbar config.
